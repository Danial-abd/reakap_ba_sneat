                ...
                <div class="card-header">
                    ...
                    <div class="row">
                            <div class="col-md-7 col-12 mt-2">
                                <form action="{{ route('search.kyw') }}" method="GET" class="form-item">
                            ...
                            <div class="col mt-2 d-grid mx-auto">
                                <a href="{{ route('tbh.kyw') }}" class="btn btn-primary">Tambah Data</a>
                            </div>
                            {{-- <div class="col mt-2 d-grid mx-auto">
                                <a href="{{ route('ctk.kyw') }}" target="_blank" class="btn btn-success">Print</a>
                            </div> --}}
                    </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('edt.kyw', $kyw->id) }}"><i
                                                            class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    <a class="dropdown-item" href="{{ route('dlt.kyw', $kyw->id) }}"><i
