...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('pg') }}" class="text-reset fw-bold">
                Data Penyebab Gangguan/</a></span> Tambah Data</h4>
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('pg-store')}}" method="POST"class="form-item">
                        @csrf

                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Penyebab</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='penyebab' id="basic-default-name"
                            ...
                            <div class="col-sm-10">
                                <select name="job" class="form-control  @error('job') is-invalid @enderror">
                                    <option value="" disabled selected>--Pilih Tiket--</option>
                                        <option value="GGN">Gangguan</option>
