...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <p><span class="text-muted fw-light"><a href="{{ route('sld') }}" class="text-reset fw-bold">
                    Saldo Material Tim/ </a></span></p>Update Data {{ $saldotim->teamlist->list_tim }}
    </h4>
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('up.hsld', $saldotim->id) }}" method="POST" class="form-item"
                        ...
                        @else
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <input type="text" class="form-control" readonly value="{{ $saldotim->teamlist->list_tim }}"
                                     id="basic-default-name" placeholder="Masukkan Nama Tim">
                                     <input type="text" hidden name='id_tim' class="form-control" readonly value="{{ $saldotim->id_tim }}"
                                     id="basic-default-name" placeholder="Masukkan Nama Tim">
                                </div>
                                ...
                                <div class="col-sm-7 mb-2">
                                    <select name="id_material"
                                        ...
                                        @foreach ($material as $m)
                                            <option value="{{ $m->id }}"
                                                {{ $m->id == $saldotim->id_material ? 'selected' : '' }}>
                                                {{ $m->nama_material }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_material')
                                ...
                                <div class="col col-sm mb-2">
                                    <input type="number" name="jumlah"
                                        ...
                                        value="{{ $saldotim->digunakan }}" placeholder="Jumlah">
                                    @error('jumlah')
                                        <div class="invalid-feedback">
