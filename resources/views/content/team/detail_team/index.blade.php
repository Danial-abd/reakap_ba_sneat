                                ...
                                <div class="input-group">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="search" class="form-control"
                                            placeholder="Cari Nama Anggota Tim" aria-label="Search..."
                            ...
                            @foreach ($teamlist as $tl)
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($teamdetail as $td)
                                            @if ($tl->id == $td->id_team)
                                                {{ $td->jobdesk->jobdesk }} {{ $td->jobdesk->jenistiket->nama_tiket }} <br>
                                            @endif
                                        @endforeach
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('edt.td', $tl->id) }}"><i
                                                        class="bx bx-edit-alt me-1"></i> Edit</a>
                                                <a class="dropdown-item" href="{{ route('dlt.td', $tl->id) }}"><i
