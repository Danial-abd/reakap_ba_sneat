...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="" class="text-reset fw-bold">
                Tiket Gangguan/</a></span> Tambah Data Tiket
    </h4>
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('spn.ggn') }}" method="POST" class="form-item">
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                {{-- <select name="id_j_tiket" readonly id="id_j_tiket" readonly class="form-control">
                                    @foreach ($jenistiket as $jt)
                                        <option value="{{ $jt->id }}" {{$jt->id == '1' ? 'selected' : '' }}>{{$jt->nama_tiket}}</option>
                                    @endforeach
                                </select> --}}
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10 gap-3 d-flex">
                                ...
                                <a href="{{ route('ggn') }}" class="btn btn-outline-danger ">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
