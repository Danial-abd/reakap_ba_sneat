...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('jt') }}" class="text-reset fw-bold">
                Tiket Pekerjaan/</a></span> Input Data Tiket Pekerjaan</h4>
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('simpan.jt') }}" method="POST" class="form-item">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Tiket</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='nama_tiket' id="basic-default-name"
