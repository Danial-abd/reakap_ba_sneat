...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('psb') }}" class="text-reset fw-bold">
                Tiket Pasang Baru/</a></span> Tambah Data Tiket
    </h4>
                    ...
                    <form action="{{ route('spn.psb') }}" method="POST" class="form-item">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('no_tiket') is-invalid @enderror"
                                    value="{{ old('no_tiket') }}" name='no_tiket' id="basic-default-name"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('nama_pic') is-invalid @enderror"
                                    value="{{ old('nama_pic') }}" name='nama_pic' id="basic-default-name"
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10 gap-3 d-flex">
                                ...
                                <a href="{{ route('psb') }}" class="btn btn-outline-danger ">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
